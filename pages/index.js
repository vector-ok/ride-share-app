  ...
  return (
    ...
    <Wrapper>
      ...
      <ActionItems>
        ...
        <InputButton>Select your ride...</InputButton>
      </ActionItems>
    </Wrapper>
  );
}
...
const Name = tw.div`w-20 text-sm text-white mx-5`;
const UserImage = tw.img`h-10 w-10 rounded-full border border-gray-200 p-px cursor-pointer`;
...
const InputButton = tw.div`h-20 bg-gray-200 text-2xl p-4 flex items-center mt-8 text-center`;
